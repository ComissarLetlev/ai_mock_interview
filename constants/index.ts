...
export const dummyInterviews: Interview[] = [
  ...
  },
  {
    ...
    level: "Senior",
    questions: ["What are the benefits of GraphQL over REST?"],
    finalized: false,
  ...
  },
  {
    ...
    level: "Mid",
    questions: ["How does a neural network learn?"],
    finalized: true,
  ...
  },
  {
    ...
    level: "Senior",
    questions: ["Explain the CI/CD pipeline process."],
    finalized: false,
  ...
  },
  {
    ...
    level: "Mid",
    questions: ["How does React Native handle animations?"],
    finalized: true,
  ...
  },
  {
    ...
    type: "Technical",
    techstack: ["Python", "Metasploit", "Wireshark", "Burp Suite"],
    level: "Junior",
    questions: ["What are the different types of cybersecurity attacks?"],
    finalized: false,

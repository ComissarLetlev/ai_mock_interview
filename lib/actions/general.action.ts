  ...
  try {
    ...
    if (hasMinimalParticipation) {
      const feedback = {
        ...
        categoryScores: [
          {
            ...
            score: 1,
            comment:
              "The candidate provided minimal or no responses during the interview.",
          },
          {
            name: "Technical Knowledge",
            score: 1,
            comment:
              "Unable to assess technical knowledge due to lack of participation.",
          },
          {
            name: "Problem Solving",
            score: 1,
            comment:
              "Unable to assess problem-solving skills due to lack of participation.",
          },
          {
            name: "Cultural Fit",
            score: 1,
            comment:
              "Minimal interaction makes it difficult to assess cultural fit.",
          },
          {
            name: "Confidence and Clarity",
            score: 1,
            comment:
              "The candidate did not engage sufficiently to demonstrate confidence or clarity.",
          },
        ],
        ...
        finalAssessment:
          "The interview was ended prematurely with minimal or no participation from the candidate. A proper assessment could not be made due to insufficient interaction. We recommend retaking the interview with full engagement to receive meaningful feedback.",
